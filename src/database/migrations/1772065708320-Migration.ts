...
export class Migration1772065708320 implements MigrationInterface {
    name = 'Migration1772065708320'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_api_keys_keyHash_isActive_deletedAt" ON "api_keys" ("keyHash", "isActive", "deletedAt") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_jobs_userId_status" ON "jobs" ("userId", "status") `);
        await queryRunner.query(`CREATE TYPE "public"."users_plan_enum" AS ENUM('basic', 'pro')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c78ab6d6c8e069972e1f4e4ad7" ON "idempotency_keys" ("userId", "idempotencyKey") `);
        ...
        await queryRunner.query(`ALTER TABLE "idempotency_keys" ADD CONSTRAINT "FK_7a3aaa526470ebb79221693d325" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "idempotency_keys" DROP CONSTRAINT "FK_7a3aaa526470ebb79221693d325"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c78ab6d6c8e069972e1f4e4ad7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_idempotency_keys_expiresAt"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_api_keys_keyHash_isActive_deletedAt"`);
